 ...
 const [m2,setValue1]=useState();
    ...
    const saveData = async () => {
      try {
        const response = await fetch('http://localhost:5000/save', {
          ...
          body: JSON.stringify(vals), // Send the entire vals array
        });
  ...
  return (
    ...
    <div>
       ...
       <div class="nav">
    <ul>
    <Link to="/Agrisem"><li class="sem">SEM</li></Link>
    ...
    <li class="PT1">PT1</li>
     ...
     <div class="content">
     <h1 class="head">ENGINEERING MATHEMATICS - PT1</h1>
      <div class="cen">
