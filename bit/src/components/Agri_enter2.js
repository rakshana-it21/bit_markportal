...
import './Agri_enter.css';
import './Agri_enter2.css';
...
const Agri_enter2 = () => {
    ...
    {id: "7376211AG151", marks:0,  val: 0, CO1: 0, marks2:0, val2: 0, CO2: 0, marks3 :0, val3 :0 , CO3: 0},{id: "7376211AG152", marks:0,  val: 0, CO1: 0, marks2:0, val2: 0, CO2: 0, marks3 :0, val3 :0 , CO3: 0},{id: "7376211AG153",marks:0,  val: 0, CO1: 0, marks2:0, val2: 0, CO2: 0, marks3 :0, val3 :0 , CO3: 0},{id: "7376211AG154", marks:0,  val: 0, CO1: 0, marks2:0, val2: 0, CO2: 0, marks3 :0, val3 :0 , CO3: 0}
      ...
      const [val, setVal] = useState([]); // Your initial state
   ...
   const [m2,setValue1]=useState();
      ...
      const saveData = async () => {
        try {
          const response = await fetch('http://localhost:5000/save', {
            ...
            body: JSON.stringify(val), // Send the entire vals array
          });
    ...
    return (
      ...
      <div>
        <div class="top"><h1>ENGINEERING MATHEMATICS - PT2</h1></div>
       ...
       <div class="content">
        ...
        <div class="cen">
         ...
         <table class="t2">
          ...
          <th>C04</th>
          <th>CO5</th>
          <th>C03_PERCENTAGE</th>
          <th>CO4_PERCENTAGE</th>
          ...
          (
            ...
            <td><input class="input-box" type='text' placeholder='co3' id={val.id}  onChange={handleCo3Change} /></td>
           
            <td><input class="input-box"  type='text'name="m2" placeholder='co4' id={val.id} onChange={handleCo2Change}/></td>
            <td><input class="input-box"  type='text' name="m3" placeholder='co5'id={val.id} onChange={handleCo1Change}/></td>
